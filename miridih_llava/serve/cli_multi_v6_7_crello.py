...
from miridih_llava.utils import merge_images
...
# replace_llama_attn_wit`h_flash_attn()
...
# bbox_layer_IMG_extract = re.compile(r"'label':\s*'([^']+)',\s*'box':\s*\[([-\d.,\s]*)\],\s*'layer':\s*(\d+),\s*'\<image(\d+)\>':\s*'<image>',\s*'file_name':\s*'([^']*)'")
# bbox_layer_IMG_extract = re.compile(r"'label':\s*'([^']+)',\s*'box':\s*\[\s*'?(.*?)'?,\s*'?(.*?)'?,\s*'?(.*?)'?,\s*'?(.*?)'?],\s*'layer':\s*(\d+),\s*'<image(\d+)>':\s*'<image>',\s*'file_name':\s*'([^']*)'")
bbox_layer_IMG_extract = re.compile(r"'label':\s*'([^']+)',\s*'box':\s*\[([-\d.]+|''),\s*([-\d.]+|''),\s*([-\d.]+|''),\s*([-\d.]+|''\s*)\],\s*'layer':\s*([\d]+),\s*'<image(\d+)>':\s*'<image>',\s*'file_name':\s*'([^']*)'")

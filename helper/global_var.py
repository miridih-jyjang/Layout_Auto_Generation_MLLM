...
TASK_INSTRUCTION = {
    ...
    "miridih_v4.6": "Could you please help me to place {num_ele} foreground elements over the background image of resolution {resolution} to craft an aesthetically pleasing, harmonious, balanced, and visually appealing web design with {template_type} style?\nPlease return the result by completing the following JSON file. Each element's location and size should be represented by a bounding box described as [left, top, width, height], and each number is a continuous digit from 0 to 1.",
    "miridih_v3": "I want to generate layout in {template_type} design format. ",
    "miridih_v6": "How can I design a {template_type} style design format with the following unordered {num_ele} foreground elements? The a canvas has resolution {resolution}, width and height each.\nFinding semantic-meaningful objects or visual foci on the background image at first might help in designing, and you should avoid any unnecessary blocking of them.\nEach element's location and size should be represented by a bounding box described as [left, top, right, bottom], and each number is a continuous digit from 0 to 1.",
    "miridih_v6.6": "How can I design a {template_type} style design format with the following unordered {num_ele} foreground elements? The a canvas has resolution {resolution}, width and height each.\nEach element's location and size should be represented by a bounding box described as [left, top, width, height], and each number is a continuous digit from 0 to 1.",
    ...
    "crello_v4.4": "Could you please help me to place {num_ele} foreground elements over the background image of resolution {resolution} to craft an aesthetically pleasing, harmonious, balanced, and visually appealing web design with {template_type} style?\nPlease return the result by completing the following JSON file. Each element's location and size should be represented by a bounding box described as [left, top, right, bottom], and each number is a continuous digit from 0 to 1.",
    "crello_v4.6": "Could you please help me to place {num_ele} foreground elements over the background image of resolution {resolution} to craft an aesthetically pleasing, harmonious, balanced, and visually appealing web design with {template_type} style?\nPlease return the result by completing the following JSON file. Each element's location and size should be represented by a bounding box described as [left, top, width, height], and each number is a continuous digit from 0 to 1.",
    "crello_v4.7": "Could you please help me to place {num_ele} foreground elements over the background image of resolution {resolution} to craft an aesthetically pleasing, harmonious, balanced, and visually appealing web design with {template_type} style?\nPlease return the result by completing the following JSON file. Each element's location and size should be represented by a bounding box described as [left, top, width, height], and each number is a continuous digit from 0 to 1.",
    "crello_v4.8": "Could you please help me to place {num_ele} foreground elements over the background image of resolution {resolution} to craft an aesthetically pleasing, harmonious, balanced, and visually appealing web design with {template_type} style?\nPlease return the result by completing the following JSON file. Each element's location and size should be represented by a bounding box described as [center x, center y, width, height], and each number is a normalized digit from 0 to 1000 by canvas shape.",
    "crello_v4.9": "Could you please help me to place {num_ele} foreground elements over the background image of resolution {resolution} to craft an aesthetically pleasing, harmonious, balanced, and visually appealing web design with {template_type} style?\nPlease return the result by completing the following JSON file. Each element's location and size should be represented by a bounding box described as [center x, center y, width, height], and each number is a normalized digit from 0 to 1000 by canvas shape.",
    "crello_v6.4": "Could you please help me to place {num_ele} foreground elements over the canvas of resolution {resolution} to craft an aesthetically pleasing, harmonious, balanced, and visually appealing web design with {template_type} style?\nPlease return the result by completing the following JSON file. Each element's location and size should be represented by a bounding box described as [left, top, right, bottom], and each number is a continuous digit from 0 to 1.",
    "crello_v6.5": "Could you please help me to place {num_ele} foreground elements over the canvas of resolution {resolution} to craft an aesthetically pleasing, harmonious, balanced, and visually appealing web design with {template_type} style?\nPlease return the result by completing the following JSON file. Each element's location and size should be represented by a bounding box described as [left, top, width, height], and each number is a continuous digit from 0 to 1.",
    "crello_v6.6": "Could you please help me to place {num_ele} foreground elements over the canvas of resolution {resolution} to craft an aesthetically pleasing, harmonious, balanced, and visually appealing web design with {template_type} style?\nPlease return the result by completing the following JSON file. Each element's location and size should be represented by a bounding box described as [left, top, width, height], and each number is a continuous digit from 0 to 1.",
    "crello_v6.7": "Could you please help me to place {num_ele} foreground elements over the canvas of resolution {resolution} to craft an aesthetically pleasing, harmonious, balanced, and visually appealing web design with {template_type} style?\nPlease return the result by completing the following JSON file. Each element's location and size should be represented by a bounding box described as [left, top, width, height], and each number is a continuous digit from 0 to 1.",
    ...
    "crello_v6.4_coord_pred": "How can I design a {template_type} style design format with the following unordered {num_ele} foreground elements? The a canvas has resolution {resolution}, width and height each.\nEach element's location and size should be represented by a bounding box described as [left, top, right, bottom], and each number is a continuous digit from 0 to 1.",
    "crello_v6.5_coord_pred": "How can I design a {template_type} style design format with the following unordered {num_ele} foreground elements? The a canvas has resolution {resolution}, width and height each.\nEach element's location and size should be represented by a bounding box described as [left, top, right, bottom], and each number is a continuous digit from 0 to 1.",
    "crello_v6.6_coord_pred": "How can I design a {template_type} style design format with the following unordered {num_ele} foreground elements? The a canvas has resolution {resolution}, width and height each.\nEach element's location and size should be represented by a bounding box described as [left, top, width, height], and each number is a continuous digit from 0 to 1.",
    "crello_v6.7_coord_pred": "How can I design a {template_type} style design format with the following unordered {num_ele} foreground elements? The a canvas has resolution {resolution}, width and height each.\nEach element's location and size should be represented by a bounding box described as [left, top, width, height], and each number is a continuous digit from 0 to 1.",

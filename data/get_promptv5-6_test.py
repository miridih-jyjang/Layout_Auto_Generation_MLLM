...
def process_json(json_path):
    ...
    for original_json in original_json_list:
        ...
        for key, value in original_json.items():     
            ...
            #     out_data["image"] = f"miridih-v6.4/images/{template_id:08}/{page_num:03}/{template_id:08}_{page_num:01}_1.png"
            # if key == "completion_seq_modeling" or key == "completion_input_seqs":
            ...
            if key == "completion_input_seqs" or key == "refinement_input_seqs":
...
def main(args):
    ...
    for json_path in json_path_list:
        ...
        # output_path = args.output_dir + "testA_cp2s.json"
        output_path = args.output_dir + "testA_refine.json"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--json-path", type=str, default="/workspace/data/scenarios/html_format/")
    parser.add_argument("--train-image-root", type=str, default="/workspace/data/scenarios/images")
    parser.add_argument("--val-image-root", type=str, default="/workspace/data/scenarios/images")
    parser.add_argument("--output-dir", type=str, default="/workspace/data/scenarios/annotations/")

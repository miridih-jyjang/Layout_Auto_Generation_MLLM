        ...
        for key, value in original_json.items():
            ...
            if 'train' in json_path:
                if key in ["cond_cate_size_to_pos_seq_modeling", "cond_cate_size_to_pos_input_seqs"]:
                    out_data["image"] = f"crello-v6.6/images/{template_id}_1.png"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--json-path", type=str, default="/workspace/data/crello-v6.6/html_format_1/")
    parser.add_argument("--output-dir", type=str, default="/workspace/data/crello-v6.6/annotations_1/")

...
def process_json(json_path):
    ...
    for original_json in original_json_list:
        ...
        for key, value in original_json.items():     
            ...
            #     out_data["image"] = f"crello-v3/images/{template_id}_1.png"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--json-path", type=str, default="data/crello-v3/html_format/")
    parser.add_argument("--train-image-root", type=str, default="data/crello-v3/images")
    parser.add_argument("--val-image-root", type=str, default="data/crello-v3/images")
    parser.add_argument("--output-dir", type=str, default="data/crello-v3/annotations/")

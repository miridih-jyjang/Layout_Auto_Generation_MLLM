...
def process_json(json_path):
    ...
    for original_json in original_json_list:
        ...
        for key, value in original_json.items():     
            ...
            # if key == "cond_cate_to_size_pos_seq_modeling":
            #     if os.path.isfile(f"data/miridih/images/{template_id:08}/{page_num:03}/{template_id:08}_{page_num:01}_1.png"):
            #         out_data["image"] = f"miridih/images/{template_id:08}/{page_num:03}/{template_id:08}_{page_num:01}_1.png"
            #     else:
            #         out_data["image"] = f"miridih/images/{template_id:08}/{page_num:03}/{template_id:08}_{page_num:01}_0.png"
...
def main(args):
    ...
    #json_path_list = [args.json_path + '/test_numerical.jsonl']
...
if __name__ == "__main__":
    ...
    parser.add_argument("--json-path", type=str, default="data/miridih-max25-v3/html_format/")
    parser.add_argument("--train-image-root", type=str, default="data/miridih-max25-v3/images")
    parser.add_argument("--val-image-root", type=str, default="data/miridih-max25-v3/images")
    parser.add_argument("--output-dir", type=str, default="data/miridih-max25-v3/annotations/")

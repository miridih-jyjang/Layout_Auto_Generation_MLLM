...
if __name__ == "__main__":
    ...
    parser.add_argument("--json-path", type=str, default="data/crello-v4/html_format/")
    parser.add_argument("--train-image-root", type=str, default="data/crello-v4/images")
    parser.add_argument("--val-image-root", type=str, default="data/crello-v4/images")
    parser.add_argument("--output-dir", type=str, default="data/crello-v4/annotations/")

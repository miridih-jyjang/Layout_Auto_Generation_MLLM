...
if __name__ == "__main__":
    ...
    parser.add_argument("--json-path", type=str, default="/workspace/data/crello-v6.5/html_format/")
    ...
    parser.add_argument("--output-dir", type=str, default="/workspace/data/crello-v6.5/annotations/")
